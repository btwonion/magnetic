...
class EnchantmentTagProvider(
    ...
    override fun addTags(registries: HolderLookup.Provider) {
        ...
        listOf(
            /*? if >=1.21.11 {*/ builder(magneticEffectId) /*?} else {*/ /*getOrCreateTagBuilder(magneticEffectId) *//*?}*/,
            /*? if >=1.21.11 {*/ builder(EnchantmentTags.TRADEABLE) /*?} else {*/ /*getOrCreateTagBuilder(EnchantmentTags.TRADEABLE) *//*?}*/,
            /*? if >=1.21.11 {*/ builder(EnchantmentTags.IN_ENCHANTING_TABLE) /*?} else {*/ /*getOrCreateTagBuilder(EnchantmentTags.IN_ENCHANTING_TABLE) *//*?}*/,
            /*? if >=1.21.11 {*/ builder(EnchantmentTags.TREASURE) /*?} else {*/ /*getOrCreateTagBuilder(EnchantmentTags.TREASURE) *//*?}*/
